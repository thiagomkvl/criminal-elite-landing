...
import heroBg from "@/assets/background-lp-criminal.jpg";

const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-[#0b0606] min-h-[82vh] md:min-h-[90vh]">
      ...
      {/* sombra inferior só no mobile, para limpar atrás dos botões */}
